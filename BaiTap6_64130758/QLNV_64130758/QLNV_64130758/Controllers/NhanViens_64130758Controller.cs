...
{
    public class NhanViens_64130758Controller : Controller
    {
        private QLNVEntities db = new QLNVEntities();

        // GET: NhanViens_64130758
        ...
        [HttpPost]
        public ActionResult TimKiem_64130758(string maNV)
        {
            var nhanViens = db.NhanViens.Where(a => a.MaNV.Contains(maNV));
            return View(nhanViens.ToList());
        }
        // GET: NhanViens_64130758/Details/5
        ...
        // POST: NhanViens_64130758/Create
        ...
        // POST: NhanViens_64130758/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: NhanViens_64130758/Delete/5
        ...
        // POST: NhanViens_64130758/Delete/5
